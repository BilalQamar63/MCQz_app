var firebaseConfig = {
    apiKey: "AIzaSyDK52Xvla3aYeB9ouztN8EdfL94ZESUZcU",
    authDomain: "quizapp786-71cfb.firebaseapp.com",
    databaseURL: "https://quizapp786-71cfb-default-rtdb.firebaseio.com",
    projectId: "quizapp786-71cfb",
    storageBucket: "quizapp786-71cfb.appspot.com",
    messagingSenderId: "409229894",
    appId: "1:409229894:web:38432958910a9a9b448847"
  };
...
var questions = [
    ...
    function nextQuestion() {
        ...
        if (nextQuiz > arrLength-1) { 
            var userScoresRef = database.ref('userScores').push();
            userScoresRef.set({
                score: score,
